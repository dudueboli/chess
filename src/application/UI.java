...
public class UI {
    ...
    //lê uma posição de xadrez (a1, b1, etc.) fornecida pelo usuário e cria um novo obj "ChessPosition" com base nessa posição.
    ...
    //imprime informações sobre a partida atual de xadrez
    ...
    //imprime o tabuleiro com as peças posicinadas
    ...
    //imprime o tabuleiro e os possiveis movimentos da peça selecionada
    ...
    //imprime uma peça de xadrez com o fundo colorido no tabuleiro. 
    ...
    private static void printCapturedPieces(ChessPiece[] captured){
        ...
        ChessPiece[] white = Arrays.stream(captured)
            .filter(x -> x != null && x.getColor() == Color.WHITE)
            .toArray(ChessPiece[]::new);
        ChessPiece[] black = Arrays.stream(captured)
